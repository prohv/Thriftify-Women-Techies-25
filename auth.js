...
import { getAuth, createUserWithEmailAndPassword, signInWithEmailAndPassword, signOut, sendEmailVerification, isSignInWithEmailLink, signInWithEmailLink } from "https://www.gstatic.com/firebasejs/10.9.0/firebase-auth.js";
...
async function signUpUser() {
    ...
    try {
        ...
        // 3.  Wait for email verification completion
...
const sendVerificationEmail = async (user) => {
    try{
        ...
        alert("Error sending verification email. Please check console for error details.")
    }
